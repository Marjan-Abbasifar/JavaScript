...
function updateInvestmentValue(value){
    document.getElementById("investment-value").innerText=`$${parseFloat(value).toLocaleString('en')}`
...
function calculateFD(){
    ...
    document.getElementById("invested-amount").innerText=`$${principal.toLocaleString('en')}`;
    document.getElementById("estimated-returns").innerText=`$${interestEarned.toLocaleString('en')}`;
    document.getElementById("total-value").innerText=`$${Math.round(totalAmount).toLocaleString('en')}`;
}